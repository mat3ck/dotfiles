# Generated by Powerlevel10k configuration wizard on 2020-04-12 at 16:53 PDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 31748.
# Wizard options: nerdfont-complete + powerline, small icons, lean_8colors, 12h time,
